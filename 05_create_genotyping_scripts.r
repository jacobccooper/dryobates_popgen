...
##############    START OPTIONS     #####################################
	...
	project_directory <- "/lustre/scratch/jmanthey/06_dryobates"
	directory_name <- "11_genotype_dryo"
	reference_genome_location <- "/home/jmanthey/references/GCA_014839835.1_bDryPub1.pri_genomic.fna"
	cluster <- "quanah"
	output_name <- "dryo_genotype"
	popmap <- "dryo_popmap.txt"
